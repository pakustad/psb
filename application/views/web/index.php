                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            ...
                            <!--    <li>Calon Siswa wajib mengambil <b>NOMOR TEST & Mengecek Ruang Ujian</b>.</li> -->
								...
								<li>Calon Siswa yang dinyatakan <b>LULUS</b> maka Wajib <b>Registrasi/Daftar Ulang dengan Membayar minimal 50% dari Total Biaya Pendidikan dan untuk pelunasannya paling lambat tanggal 9 Juli 2022</b> di <b>SMA PESANTREN TERPADU HAYATAN THAYYIBAH</b>.</li>
															</ol>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row" style="margin-top:-100px;margin-bottom:-105px;">
                <div class="col-lg-4 text-center">
                  <br><br>
                    ...
                    <br>
                    <a href="http://www.smahatoy.sch.id" target="_blank"><h4 class="btn btn-success">SMA PESANTREN TERPADU HAYATAN THAYYIBAH </h4></a>
                </div>
