<div class="panel panel-primary">
  <div class="panel-heading">
    <h2>Ketentuan PPDB <br><strong class="text-success" style="color:#eee;">SMA PESANTREN TERPADU HAYATAN THAYYIBAH</strong></h2>
    <!-- <hr> -->
  </div>
  <div class="panel-body">
    ...
    <ol style="color:#333;">
      ...
      <li>Calon siswa yang sudah mendaftarkan diri melalui PPDB Online SMA PESANTREN TERPADU HAYATAN THAYYIBAH wajib menyerahkan dokumen persyaratan yang sudah ditentukan oleh Panitia PPDB SMA PESANTREN TERPADU HAYATAN THAYYIBAH.</li>

      <li>Setiap calon siswa yang mendaftar wajib mengikuti tes seleksi yang diadakan oleh panitia PPDB SMA PESANTREN TERPADU HAYATAN THAYYIBAH.</li>

      <li>Data yang sudah diberikan oleh Panitia PPDB SMA PESANTREN TERPADU HAYATAN THAYYIBAH hanya digunakan untuk keperluan penerimaan siswa baru dan <strong class="text-danger">data tidak akan dipublikasikan serta dijaga kerahasiaannya oleh Panita PPDB</strong>.</li>
