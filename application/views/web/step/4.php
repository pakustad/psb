<div class="panel panel-primary">
  ...
  <div class="panel-body">
    ...
    <div class="col-sm-9" style="margin-top:3px;">
      <select class="form-control bg-blue class" data-placeholder="Pilih Model Ujian Nasional" name="model_un" data-parsley-group="block3" data-parsley-errors-container='div[id="error-model_un"]'>
