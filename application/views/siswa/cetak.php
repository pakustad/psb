...
<html>
  ...
  <body onload="window.print();">
    ...
    <table width="100%" style="margin-left:15px;">
      ...
      <tr>
        <td colspan="5">Semua berkas dimasukan kedalam map plastik berlubang (Contoh: merk folder one), Program Boarding warna hijau, Program Fullday ihwan warna biru dan ahwat warna merah</td>
      </tr>
    </table>
